...
function App() {
  ...
  return (
    <div className="App">
        ...
        <section id="hero">
          {/* Flex Container */}
          <div className="container flex flex-col-reverse  md:flex-row items-center px-6 mx-auto mt-6 md:space-y-0">
            {/* Left Item */}
            <div className="flex flex-col mb-32 space-y-12 md:w-1/2">
              <h1 className="max-w-md leading-tight text-4xl font-bold text-center md:text-5xl md:text-left">
              ...
              <div className="flex justify-center md:justify-start">
                <a href="/" className="px-6 pt-2 p-3 text-white text-center bg-brightRed rounded-full baseline font-semibold hover:bg-brightRedLight">Get Started</a> {/* Red button */}
              </div>
            </div>
            {/* Image Item */}
    ...
    <a href="" className="mt-10 px-6 pt-2 p-3 text-white text-center bg-brightRed rounded-full font-medium hover:bg-brightRedLight">Get Started</a>
  </div>
        ...
        <div className="bg-brightRed">
          <div className="mt-14 py-24 px-6 flex-col  bg-brightRed container md:px-6 md:py-12 mx-auto flex md:flex-row justify-between">
              <h4 className='text-5xl md:text-4xl text-center md:text-left max-w-xl leading-tight text-white font-bold'>Simplify how your team works today</h4>
        ...
        <div className="bg-veryDarkBlue" id="footer">
          <div className="container mx-auto flex flex-col gap-14 lg:flex-row items-center lg:justify-between py-16 lg:py-10 px-6 md:flex-row flex-wrap md:justify-center md:gap-x-24">
            {/* First Element */}
            ...
            {/* Second Element */}
            <div className="columns-2 flex flex-row gap-24 lg:gap-16 ">
                  <ul className="flex flex-col space-y-3 text-center lg:items-start">
            ...
            <div className="flex flex-col space-y-16 items-center lg:mt-0 lg:items-start md:mt-16">
              <div className="flex-flex-row space-x-3">
                <input className="focus:outline-none rounded-full py-2 px-1 bg-white" placeholder="Updated in your inbox" type="text" />
                <button className="bg-brightRed rounded-full  px-3 lg:px-4 py-2 text-white hover:bg-darkGrayishBlue">Go</button>
              </div>
