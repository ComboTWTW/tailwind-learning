...
const Testimonials = () => (
  <div className="max-w-6xl container mx-auto flex flex-col mt-32 items-center px-4 space-x-6">
    <h2 className=" text-4xl font-bold text-center">
        What's different About Manage?
    </h2>

    <div className="flex flex-col space-y-16 mt-10 md:flex-row md:space-x-6">
      {TestCard.map((card) => (
